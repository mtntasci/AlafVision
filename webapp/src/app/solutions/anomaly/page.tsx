        ...
        <section className="w-full container mx-auto px-6 py-12 mb-24">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-6 max-w-4xl mx-auto">
            ...
            <div className="group p-8 rounded-3xl bg-slate-900 border border-white/5 hover:border-blue-500/30 transition-all hover:bg-slate-800/80">
              ...
              <h3 className="text-2xl font-bold text-white mb-3">Şüpheli Paket / Bagaj</h3>
            ...
            <div className="group p-8 rounded-3xl bg-slate-900 border border-white/5 hover:border-blue-500/30 transition-all hover:bg-slate-800/80">
              ...
              <h3 className="text-2xl font-bold text-white mb-3">Agresif Davranış ve Kavga</h3>
              <p className="text-slate-400 leading-relaxed">
            ...
            <div className="group p-8 rounded-3xl bg-slate-900 border border-white/5 hover:border-blue-500/30 transition-all hover:bg-slate-800/80">
              ...
              <h3 className="text-2xl font-bold text-white mb-3">Erken Yangın Tespiti</h3>
              <p className="text-slate-400 leading-relaxed">
            ...
            <div className="group p-8 rounded-3xl bg-slate-900 border border-white/5 hover:border-blue-500/30 transition-all hover:bg-slate-800/80">
              ...
              <h3 className="text-2xl font-bold text-white mb-3">Çevre Güvenliği</h3>
              <p className="text-slate-400 leading-relaxed">
