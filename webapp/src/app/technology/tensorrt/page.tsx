          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 max-w-6xl mx-auto">
            ...
            <div className="group p-8 rounded-3xl bg-slate-900 border border-white/5 hover:border-blue-500/30 transition-all hover:bg-slate-800/80 text-center">
              <div className="w-14 h-14 rounded-2xl bg-blue-500/10 flex items-center justify-center mx-auto mb-6 border border-blue-500/20">
                <Maximize className="w-7 h-7 text-blue-400" />
              </div>
              <h3 className="text-xl font-bold text-white mb-3">Model Optimizasyonu</h3>
            ...
            <div className="group p-8 rounded-3xl bg-slate-900 border border-white/5 hover:border-blue-500/30 transition-all hover:bg-slate-800/80 text-center">
              ...
              <h3 className="text-xl font-bold text-white mb-3">Daha Yüksek FPS</h3>
              <p className="text-sm text-slate-400 leading-relaxed">
            ...
            <div className="group p-8 rounded-3xl bg-slate-900 border border-white/5 hover:border-blue-500/30 transition-all hover:bg-slate-800/80 text-center">
              ...
              <h3 className="text-xl font-bold text-white mb-3">Sıfır Gecikme (Latency)</h3>
              <p className="text-sm text-slate-400 leading-relaxed">
            ...
            <div className="group p-8 rounded-3xl bg-slate-900 border border-white/5 hover:border-blue-500/30 transition-all hover:bg-slate-800/80 text-center">
              ...
              <h3 className="text-xl font-bold text-white mb-3">Donanıma Özel Derleme</h3>
              <p className="text-sm text-slate-400 leading-relaxed">
