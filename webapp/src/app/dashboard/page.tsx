  ...
  return (
    <div className="min-h-screen bg-background flex flex-col relative overflow-hidden font-sans">
      ...
      <main className="flex-1 relative z-10 flex flex-col items-center justify-center p-6 mt-20">
        ...
        <div className="max-w-7xl w-full grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 animate-in slide-in-from-bottom-6 fade-in duration-700">
          ...
          <Link href="/dashboard/vehicle" className="flex flex-col items-center justify-center gap-6 p-10 bg-surface-1 border border-border-subtle rounded-[2rem] hover:border-accent hover:bg-surface-2 transition-all shadow-xl group text-center cursor-pointer">
            ...
            <div>
              <h3 className="text-2xl font-black text-primary-text mb-3">Araç Tanıma</h3>
          ...
          <Link href="/dashboard/human" className="flex flex-col items-center justify-center gap-6 p-10 bg-surface-1 border border-border-subtle rounded-[2rem] hover:border-blue-500 hover:bg-surface-2 transition-all shadow-xl group text-center cursor-pointer">
            ...
            <div>
              <h3 className="text-2xl font-black text-primary-text mb-3">Yüz Tanıma & Kavga Tespiti</h3>
              <p className="text-secondary-text font-medium leading-relaxed">
          ...
          <Link href="/dashboard/store" className="flex flex-col items-center justify-center gap-6 p-10 bg-surface-1 border border-border-subtle rounded-[2rem] hover:border-emerald-500 hover:bg-surface-2 transition-all shadow-xl group text-center cursor-pointer">
            <div className="w-24 h-24 rounded-3xl bg-emerald-500/10 flex items-center justify-center group-hover:scale-110 transition-transform duration-300">
              <svg className="w-12 h-12 text-emerald-500" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M16 8v8m-4-5v5m-4-2v2m-2 4h12a2 2 0 002-2V6a2 2 0 00-2-2H6a2 2 0 00-2 2v12a2 2 0 002 2z" />
              </svg>
            </div>
            <div>
              <h3 className="text-2xl font-black text-primary-text mb-3">Mağaza İstatistikleri</h3>
              <p className="text-secondary-text font-medium leading-relaxed">
